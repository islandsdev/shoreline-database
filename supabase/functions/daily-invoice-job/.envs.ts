...
export function getEnv(isTest = false) {
  ...
  return {
    ...
    WISE_API_KEY: isTest ? Deno.env.get("WISE_API_KEY_TEST") : Deno.env.get("WISE_API_KEY"),
    WISE_BALANCE_ID: isTest ? Deno.env.get("WISE_BALANCE_ID_TEST") : Deno.env.get("WISE_BALANCE_ID"),
    WISE_PROFILE_ID: isTest ? Deno.env.get("WISE_PROFILE_ID_TEST") : Deno.env.get("WISE_PROFILE_ID"),
